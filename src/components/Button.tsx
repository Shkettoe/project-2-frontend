...
export const Button = styled.button<iCommonSt>`
    padding: 6px 16px;
    ...
    @media (max-width: 720px) {
      width: ${props => `${parseInt(props.width?.toString().substring(0, props.width?.toString().length - 2) || "420px") / 1.3}px` || `${parseInt(props.style?.width?.toString().substring(0, props.style?.width?.toString().length - 2) || "420px") / 1.3}px`};
    }
    &:hover{
